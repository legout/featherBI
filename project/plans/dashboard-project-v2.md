...
**Status:** approved. Owner approved the complete target specification and five-ticket staged decomposition in the 2026-09-16 design session, then approved blocking follow-up #9 when final issue #7 review found an incomplete Perspective-first mapping.
